...
_NORM_MEANS = np.array(
    [
        85.0, 10.0, 60.0, 110.0, 0.0,    # hr: mean, std, min, max, trend
        120.0, 15.0, 90.0, 150.0, 0.0,   # bp_sys
        80.0, 8.0, 60.0, 100.0, 0.0,     # bp_dia
        96.0, 2.0, 90.0, 100.0, 0.0,     # o2
    ],
    dtype=np.float32,
)
_NORM_STDS = np.array(
    [
        15.0, 5.0, 15.0, 15.0, 1.0,      # hr
        20.0, 8.0, 15.0, 20.0, 1.0,      # bp_sys
        10.0, 4.0, 10.0, 10.0, 1.0,      # bp_dia
        2.0, 1.0, 5.0, 2.0, 1.0,         # o2
    ],
    dtype=np.float32,
)
